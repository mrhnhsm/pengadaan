...
const InvestasiRealRupa = ({ detailMode = false, data }) => {
  const options = {
    chart: {
      type: 'pie',
    ...
    title: {
      text: detailMode ? 'CHART INVESTASI (REAL VS RUPA)' : '',
      style: {
        color: '#333333',
    ...
    plotOptions: {
      pie: {
        ...
        dataLabels: {
          ...
          distance: 10, // Jarak label dari pie
...
export default InvestasiRealRupa;
